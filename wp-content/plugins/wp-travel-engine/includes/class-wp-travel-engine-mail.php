...
class Wp_Travel_Engine_Mail_Template
{
	...
	function mail_editor( $settings, $pid )
	{
		...
		$price = wp_travel_engine_get_formated_price_with_currency_code_symbol( $settings['place_order']['cost'] ); 
		$due = isset( $settings['place_order']['due'] ) ? wp_travel_engine_get_formated_price_with_currency_code_symbol( $settings['place_order']['due'] ) : '' ;
		...
		$total_cost = wp_travel_engine_get_formated_price_with_currency_code_symbol( $total_cost );
		...
		$tprice = wp_travel_engine_get_formated_price_with_currency_code_symbol( $tripprice );
