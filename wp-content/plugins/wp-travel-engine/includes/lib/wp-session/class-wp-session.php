...
class WP_Session implements ArrayAccess, Iterator, Countable {
	...
	private function __construct() {
		if ( isset( $_COOKIE[WP_TRAVEL_ENGINE_SESSION_COOKIE] ) ) {
			$this->session_id = stripslashes( $_COOKIE[WP_TRAVEL_ENGINE_SESSION_COOKIE] );
		} else {
		...
		setcookie( WP_TRAVEL_ENGINE_SESSION_COOKIE, $this->session_id, $this->expires, COOKIEPATH, COOKIE_DOMAIN );
	}
	...
	public function regenerate_id( $delete_old = false ) {
		...
		setcookie( WP_TRAVEL_ENGINE_SESSION_COOKIE, $this->session_id, time() + $this->expires, COOKIEPATH, COOKIE_DOMAIN );
	}
