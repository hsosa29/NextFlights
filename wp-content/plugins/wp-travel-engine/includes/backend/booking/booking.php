                        ...
                        ?>
                            <div class='wp-travel-engine-personal-details'>
                                ...
                                switch ($key) {
                                    ...
                                    <input type="text" value="<?php echo isset( $value ) ? esc_attr( $value ): '';?>" name="wp_travel_engine_booking_setting[place_order][travelers][<?php echo esc_attr( $key );?>][<?php echo $i;?>]" id="wp_travel_engine_booking_setting[place_order][travelers][<?php echo esc_attr( $key );?>][<?php echo $i;?>]" > 
                                    <?php
                                    break;
