    ...
    <div class="wp-travel-engine-billing-details-wrapper">
        ...
        <div class='wp-travel-engine-billing-details-field-wrap'>
                ...
                switch ($key) {
                    ...
                    <input type="email" value="<?php echo isset( $value ) ? esc_attr( $value ):'' ;?>" name="wp_travel_engine_booking_setting[place_order][booking][<?php echo esc_attr( $key );?>]" id="wp_travel_engine_booking_setting[place_order][booking][<?php echo esc_attr( $key );?>]" >    
                    <?php
                    break;
