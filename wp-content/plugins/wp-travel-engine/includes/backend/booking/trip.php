...
<div class="trip-info-meta">
	...
	<div>
	<label for="wp_travel_engine_booking_setting[place_order][due]"><?php _e('Remaining Payment: ','wp-travel-engine');echo esc_attr($currency);?></label>
	...
	<div>
	<label for="wp_travel_engine_booking_setting[place_order][total]"><?php _e('Total Cost: ','wp-travel-engine');echo esc_attr($currency);?></label>
	<input type="text" id="wp_travel_engine_booking_setting[place_order][total]" name="wp_travel_engine_booking_setting[place_order][total]" value="<?php echo isset($wp_travel_engine_postmeta_settings['place_order']['due']) && $wp_travel_engine_postmeta_settings['place_order']['due'] != '' ? floatval($wp_travel_engine_postmeta_settings['place_order']['cost']) + floatval( $wp_travel_engine_postmeta_settings['place_order']['due']) : esc_attr($wp_travel_engine_postmeta_settings['place_order']['cost'])?>">
	</div>
	<div>
