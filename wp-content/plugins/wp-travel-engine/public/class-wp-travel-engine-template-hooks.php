...
class WP_Travel_Engine_Template_Hooks {
    ...
    public function booking_form_traveller_inputs() {
        ...
        // Get trip price.
        $is_sale_price_enabled = isset( $post_meta['sale'] ) ? true : false;
        $sale_price            = isset( $post_meta['trip_price'] ) ? $post_meta['trip_price'] : '';
        $regular_price         = isset( $post_meta['trip_prev_price'] ) ? $post_meta['trip_prev_price'] : '';
        $price = ( true === $is_sale_price_enabled ) ? $sale_price : $regular_price;
                        ...
                        <div class="wpte-bf-traveler">
                            <div class="wpte-bf-number-field">
                                <input type="text" name="add-member" value="<?php echo esc_attr( $value ); ?>" min="<?php echo esc_attr( $min_pax ) ?>" max="<?php echo esc_attr( $max_pax ); ?>"
                                    ...
                                    data-type = '<?php echo esc_attr( $pricing_label ); ?>'
                                    data-cost="<?php echo esc_attr( $price ); ?>"
