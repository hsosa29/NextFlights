...
$payment_debug_mode        = isset( $wp_travel_engine_settings['payment_debug'] ) && $wp_travel_engine_settings['payment_debug'] != '' ? true : false;
...
define( 'WP_TRAVEL_ENGINE_VERSION', '3.0.5' );
...
function wte_activate() {
    ...
    if ( empty( $wp_travel_engine_option_settings ) ) return;
