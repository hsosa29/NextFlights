...
* Fix - PHP warnings fixed when FAQs are not set fro trips.
...
Released on: 9th January, 2020

Features:

* Compatibility check with other addons.
* Message to receive latest news, updates and offers.

Enhancements:

* Days/Nights added on trip cards in plugin template pages.
* Cost Includes/Excludes issue resolved.

Fixes:

* Carousel extra div issue resolved.
* Minor bug fixes.

= 2.2.9 =

Released on: 26th December, 2019

Enhancements:

* Added {enquirer_name}, {enquirer_email} email tags for Enquiry Subject.
* Test Mode added for Payment Methods (PayPal, PayPal Express).
* jQuery validater added.

Fixes:

* Multiple Nonce in Plugin License page fixed.
* Posts order issue resolved.
* Minor bug fixes.

= 2.2.8 =

Released on: 11th December, 2019

Features:

* Added Clone feature for Trips Post Type.
* Test Mode added for Payment Methods (PayPal).

Enhancements:

* Hooks added for Affiliate Booking add-on.
...
Released on: 29th November, 2019

Fixes:

* Add-ons update notification issue resolved.
* Trip Facts update issue resolved.
* Minor bug fixes.

= 2.2.6 =

Released on: 22nd November, 2019

Enhancements:

* Redirect to current tab on global settings save/update.

Fixes:

* Add-ons license activation issue resolved.
* Minor bug fixes.
...
* Filter added for thousands separator.

Fixes:

* Plugin registered Page Template updating failed issue in Gutenberg fixed.
* Minor bug fixes.

= 2.2.4 =

Released on: 7th November, 2019

Features:

* Permalink structure change option for Trip, Destination, Activity and Trip Types added.

Enhancements:

* Helper functions added for Trips Embedder add-on.
...
* Order by parameter added for Trip Shortcode.
* Hooks added for Trips Embedder and Extra Services add-ons.
...
* Trip Listing page template double title issue fixed.
* Next Departure title removed for expired dates.
* Group Discount global settings issue fixed.
* Minor bug fixes.

Enhancements:

* Fetched EDD addons data dynamically using API.
* No. of seats set to max while booking through booking calendar in FSD add-on.
...
* Shortcode rendering issue in Gutenberg editor fixed.
* Minor bug fixes.

Enhancements:

* Hooks added for add-ons support.
* Template and taxonomy pages content refactor.
* Itinerary list sortable feature added. 
* FAQs list sortable feature added.

= 2.1.9 =
* Enhancement - Shortcode enabled in Itinerary and FAQs Tabs. 
* Enhancement - 'WP Travel Engine' renamed to 'WordPress Travel Booking Plugin - WP Travel Engine'

= 2.1.8 =
* Shortcode enabled in Trip Tabs
* Allowed to change Date in Booking Form

= 2.1.7 =
* Feature to change year in the Booking Form Datepicker
* Booking Order #order_id error fixed

= 2.1.6 =
* Booking and Purchase Email Templates optimized

= 2.1.5 =
* Option to enable/disable Emergency Contact Details in Travelers Information Form
* Passport field added in the Booking Details in backend 
* Thousands Separator bug fixing
* Trip Info made sortable in Settings Tab

= 2.1.4 =
* Option to enable taxonomy image in the taxonomy page
* Updated Group Discount message in Booking Form

= 2.1.3 =
* Booking Form Optimized

= 2.1.2 =
* FAQ Page Schema in FAQ Trip Tabs
* French Translation files added
* Trip Schema Optimized
...
= 2.0.9 =
* Trip Page Templates made compatible with Gutenberg
* Space added between Currency Symbol and Trip Price
* Option to display either Currency Symbol or Code in Trip Listing Templates
* Trip Listing template updated 
* Trip Schema updated and more SEO friendly
