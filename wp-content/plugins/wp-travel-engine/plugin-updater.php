...
function wp_travel_engine_license_page() {
	...
	?>
	<div class="wrap">
		<h1 class="wp-heading-inline"><?php _e( 'Plugin License Options', 'wp-travel-engine' ); ?></h1>
							...
							<tr valign="top">
								...
								<td>
									<?php if( $wte_fixed_departure_status == 'valid' ) { ?>
										<span class="active-msg" style="color:green;"><?php echo __( 'Your license key has been activated.', 'wp-travel-engine' ); ?></span>
									...
									<?php } else { ?>
										<span class="active-msg" style="color:red;"><?php echo __( 'Please activate your license.', 'wp-travel-engine' ); ?></span>
